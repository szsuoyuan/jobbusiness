...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath}/oa/findCustomerListByPage">
    <input type="hidden" name="pageNum" value="1"/>
	<input type="hidden" name="numPerPage" value="${customlist.pageSize }"/><!-- 每页显示多少条 -->
</form>
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath}/oa/findCustomerListByPage" method="post">
	<div class="searchBar">
