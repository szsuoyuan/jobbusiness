...
<div class="pageContent">
		<form method="post" action="ws/updateApplogo" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this,dialogAjaxDone);">
		...
		<div class="pageFormContent nowrap" layoutH="56" >
			<dl>
				...
				<dd  style="width: 70%">
					<img alt="" src="ws/showApplogo?id=${bgpic.bgid }" width="30%">
				</dd>
			</dl>			
			<dl>
