...
<div class="pageContent">
	<form method="post" action="ws/addFirstType" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent nowrap" layoutH="56">		
			   <dl>
					<dt style="width:80px">一级分类：</dt>
					<dd  style="width:200px">
						<input name="tname" type="text" size="28"  class="required"  alt="请输入一级类别名"/>
					</dd>
