...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="wx/PreManyArticle" target="navTab"><span>添加多图文</span></a></li>
			<li><a class="delete" href="wx/delManArticle?id={sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="wx/findManArticleById?id={sid_user}" target="navTab" title="修改多图文"><span>修改</span></a></li>
